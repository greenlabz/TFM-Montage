        ...
        <div className="article-layout">
          ...
          <div className="article-content">
            ...
            <Reveal className="article-cta">
              ...
              <a className="conversion-cta" href={`https://wa.me/491709980942?text=${encodeURIComponent(`Hallo Thomas, ich habe den Ratgeber "${guide.title}" gelesen. Hier ist ein Foto von meinem Projekt:`)}`} target="_blank" rel="noreferrer">
