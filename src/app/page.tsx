  ...
  return (
    <div className="min-h-screen overflow-x-clip bg-[var(--background)] text-[var(--foreground)] font-body">
      ...
      <section id="gallery" ref={galleryRef} className="relative h-[300svh] bg-[#212121]">
        <div className="sticky top-0 h-svh overflow-hidden flex items-start pt-20 md:h-screen md:pt-32">
          <motion.div style={{ x: galleryX }} className="flex gap-8 md:gap-10 items-start shrink-0 w-[250vw] md:w-[200vw]">
            ...
            <div className="flex h-[calc(100vh-6rem)] w-screen shrink-0 items-start px-6 md:h-[calc(100vh-8rem)] md:px-16">
      ...
      <section className="relative bg-[#212121] py-24 md:py-32">
        <div className="max-w-7xl mx-auto px-6 md:px-16 text-center">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-6 items-center">
            ...
            <a href="https://wa.me/491700980942" target="_blank" rel="noopener noreferrer" className="conversion-cta inline-flex w-full items-center justify-center gap-3 rounded-full px-10 py-5 font-display text-sm uppercase tracking-widest sm:w-auto">
